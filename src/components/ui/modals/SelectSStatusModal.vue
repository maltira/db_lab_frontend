...
const results: ('Активный' | 'Истёкший')[] = ['Активный', 'Истёкший']

interface Props {
  isOpen: boolean
  status: 'Активный' | 'Истёкший' | null // текущий result
}
const props = defineProps<Props>()

const emit = defineEmits<{
  close: []
  statusUpdated: [res: 'Активный' | 'Истёкший']
}>()
...
const handleResult = (res: 'Активный' | 'Истёкший') => {
  if (res != props.status) {
...
<template>
  <div class="modal-container" :class="{ active: isOpen }" @click="handleClose">
    <div class="modal-content" @click.stop>
      ...
      <h1>Выберите статус регистрации</h1>
