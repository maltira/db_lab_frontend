...
export const useSidebarStore = defineStore('sidebar', {
  state: () => ({
    ...
    allForms: [
      ...
      { id: 3, route: '/form/data/ships', name: "ФАД_Судна"},
      { id: 4, route: '/form/data/inspectors', name: "ФАД_Инспекторы"},
      { id: 5, route: '/form/data/inspections/ship', name: "ФАД_ТехОсмотры"},
      { id: 6, route: '/form/data/violation/ship', name: "ФАД_Нарушения"},
    ] as SidebarElement[],
